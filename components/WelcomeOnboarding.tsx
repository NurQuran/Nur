...
const words={
  fr:{welcome:"Bienvenue",lead:"Préparons Nūr pour votre première lecture.",language:"Choisissez votre langue",reading:"Votre lecture",readingLead:"Sélectionnez une transmission, une voix et l’affichage des couleurs.",riwayah:"Transmission",voice:"Voix",colors:"Couleurs de tajwīd",appearance:"Votre ambiance",appearanceLead:"Choisissez le thème qui vous accompagne le mieux.",dark:"Sombre",light:"Clair",next:"Continuer",start:"Démarrer"},
  en:{welcome:"Hello",lead:"Let’s prepare Nūr for your first reading.",language:"Choose your language",reading:"Your reading",readingLead:"Select a transmission, a voice and color display.",riwayah:"Transmission",voice:"Voice",colors:"Tajweed colors",appearance:"Your atmosphere",appearanceLead:"Choose the theme that feels right for you.",dark:"Dark",light:"Light",next:"Continue",start:"Start"},
  ar:{welcome:"مرحبًا",lead:"لنُعِدّ نُور لقراءتك الأولى.",language:"اختر لغتك",reading:"قراءتك",readingLead:"اختر الرواية والصوت وعرض ألوان التجويد.",riwayah:"الرواية",voice:"الصوت",colors:"ألوان التجويد",appearance:"أجواء القراءة",appearanceLead:"اختر المظهر الأنسب لك.",dark:"داكن",light:"فاتح",next:"متابعة",start:"ابدأ"},
} as const;
...
export default function WelcomeOnboarding(){
  ...
  return <div className="onboarding-layer" role="presentation"><section className="onboarding-card" role="dialog" aria-modal="true" aria-labelledby="onboarding-title" dir={language==="ar"?"rtl":"ltr"}>
    ...
    <div className="onboarding-actions">{step>0&&<button className="onboarding-back" onClick={()=>setStep(value=>value-1)} aria-label="Retour"><span/></button>}<button className="onboarding-next" onClick={()=>step<2?setStep(value=>value+1):finish()}>{step<2?text.next:text.start}<span className="onboarding-arrow" aria-hidden="true"/></button></div>
  </section></div>;
}
